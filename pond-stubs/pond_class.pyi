...
class Pond:
    ...
    def __init__(
        self,
        borrowed_timeout: int = ...,
        time_between_eviction_runs: int = ...,
        eviction_weight: float = ...,
        thread_daemon: bool = ...,
        loop=...,
    ) -> None: ...
    def register(
        self, factory: Optional[PooledObjectFactory] = ..., name: Optional[str] = ...
    ): ...
    def borrow(
        self, factory: Optional[PooledObjectFactory] = ..., name: Optional[str] = ...
    ) -> PooledObject: ...
    def recycle(
        ...
        factory: Optional[PooledObjectFactory] = ...,
        name: Optional[str] = ...,
    ): ...
    def clear(
        self, factory: Optional[PooledObjectFactory] = ..., name: Optional[str] = ...
